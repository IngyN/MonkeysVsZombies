...
my $potato_block= Block -> new ("Name", "Title of document", Style->new(".0.", "25", ".0.", "Name"));
$blockList[0] = $potato_block;


my $potato_block2= Block -> new ("Heading1", "Sample Page", Style->new(".0.", "18", "bold", "Heading1"));

$blockList[1] = $potato_block2;


my $potato_block3= Block -> new ("Heading2", "Hi", Style->new(".0.", "16", "italic", "Heading2", "#FF0000"));
$blockList[2] = $potato_block3;

my $potato_block4= Block -> new ("Normal", "Hello World", Style->new(".0.", "12", ".0.", "Normal", "blue"));
$blockList[3] = $potato_block4;

my $potato_block5= Block -> new ("Footer", "Second para", Style->new(".0.", "12", ".0.", "Footer", "blue"));
$blockList[4] = $potato_block5;
$potato_block5->setText("heellllooooo");

 $potato_block= Block -> new ("Name", "Title of document", Style->new(".0.", "25", ".0.", "Name"));
...
my @styleList = {};
my @style_names = qw/Title Heading1 Heading2 Heading3 Heading4 Header Footer Normal/;
...
foreach my $o (0.. $#style_names)
{
    ...
    push (@styleList, $tomato_potato);
}

# foreach my $z (0 .. $#styleList)
# {
    # say $styleList[$z]->getBasedOn();
# }

sub check 
{
    my (@list, $potato_style) = @_;
    foreach my $i (@list)
    {
...
# {
    ...
    # if(check(@styleList, $potato_temp))
    # {
        # push(@styleList, $potato_temp);
    # }
     # #say $blockList[$k]->getStyle()->getSize();
# }
